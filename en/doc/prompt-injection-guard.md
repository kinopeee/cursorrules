...
The file `.cursor/rules/prompt-injection-guard/RULE.md` defines the **core defense logic** that the AI must obey immediately.  
...
- Implementation rules: [`.cursor/rules/prompt-injection-guard/RULE.md`](../.cursor/rules/prompt-injection-guard/RULE.md)
...
- In normal operation, keep `.cursor/rules/prompt-injection-guard/RULE.md` set to **Always Apply** so that the guard is always active.
...
The strict guardrails the AI must follow are always defined by `.cursor/rules/prompt-injection-guard/RULE.md`.
